...
var sqlite3InitModule = (() => {
  ...
  return function (sqlite3InitModule) {
...
*/
    ...
    const sqlite3InitModuleState =
      self.sqlite3InitModuleState || Object.create(null);
...
*/
    ...
    Module[xNameOfInstantiateWasm] = function callee(imports, onSuccess) {
      ...
      const uri = Module.locateFile(
        callee.uri,
        "undefined" ===
          typeof scriptDirectory /*var defined by Emscripten glue*/
          ? ""
          : scriptDirectory
      );
...
/** not-t@type {!BigUint64Array} */
    ...
    function createWasm() {
      ...
      function receiveInstance(instance, module) {
        ...
        exports = relocateExports(exports, 4096);
      ...
      init: function () {
        ...
        var wasmPlugin = {
          ...
          handle: function (byteArray, name, onload, onerror) {
            ...
            wasmPlugin["asyncWasmLoadPromise"] = wasmPlugin[
              "asyncWasmLoadPromise"
            ]
              .then(() =>
                loadWebAssemblyModule(byteArray, {
                  loadAsync: true,
                  nodelete: true,
                })
              )
              .then(
                ...
                (err) => {
                  console.warn(
                    "Couldn't instantiate wasm: " + name + " '" + err + "'"
                  );
                  onerror();
                }
              );
    ...
    var ___wasm_apply_data_relocs = (Module["___wasm_apply_data_relocs"] =
      function () {
        return (___wasm_apply_data_relocs = Module[
    ...
    /** @type {function(...*):?} */
    var _sqlite3_enable_load_extension = (Module[
      "_sqlite3_enable_load_extension"
    ] = function () {
      return (_sqlite3_enable_load_extension = Module[
        "_sqlite3_enable_load_extension"
      ] =
        Module["asm"]["sqlite3_enable_load_extension"]).apply(null, arguments);
    });
...
*/
    ...
    Module.postRun.push(function (
      Module /*the Emscripten-style module object*/
    ) {
      "use strict";
...
*/
  ...
  */
        const isInt32 = (n) => {
          return (
            "bigint" !==
              typeof n /*TypeError: can't convert BigInt to number*/ &&
          ...
          switch (valType) {
            case capi.SQLITE_INTEGER:
              if (wasm.bigIntEnabled) {
                ...
                arg =
                  capi.sqlite3_value_double(
                    pVal
                  ) /*yes, double, for larger integers*/;
              break;
  ...
  */
      ...
      */
            tgt.push(
              capi.sqlite3_value_to_js(wasm.peekPtr(pArgv + wasm.ptrSizeof * i))
            );
          }
          return tgt;
        };
  ...
  */
        capi.sqlite3_result_error_js = function (pCtx, e) {
         ...
         the exception's type name in the result. */ capi.sqlite3_result_error(
              pCtx,
              "" + e,
              -1
            );
...
*/
  ...
  */
        ...
        const __allocCStr = function (
          ...
          if (0) {
            /* older impl, possibly more widely compatible? */
            const n = target.jstrlen(jstr),
              ptr = allocator(n + 1);
            target.jstrcpy(jstr, target.heap8u(), ptr, n + 1, true);
            return returnWithLength ? [ptr, n] : ptr;
          } else {
            /* newer, (probably) faster and (certainly) simpler impl */
  ...
  */
        xArg.FuncPtrAdapter = class FuncPtrAdapter extends AbstractArgAdapter {
          constructor(opt) {
            ...
            if (opt.contextKey)
              this.contextKey = opt.contextKey /*else inherit one*/;
          ...
          static bindScopes = ["transient", "context", "singleton"];
...
```
  ...
  */
        target.xWrap = function (fname, resultType, ...argTypes) {
          ...
          /*Verify the arg type conversions are valid...*/ if (
            undefined !== resultType &&
            null !== resultType
          )
        ...
        */
              for (const i in args)
                args[i] = cxw.convertArg(argTypes[i], args[i], i, args);
  ...
  */
        target.xCallWrapped = function (fname, resultType, argTypes, ...args) {
          ...
          return target
            .xWrap(fname, resultType, argTypes || [])
            .apply(null, args || []);
        };
  ...
  */
        ...
        direct reuse in each accessor function. */
            ...
            a.forEach(function (v) {
              //const ir = sigIR(v);
              f._.getters[v] =
                sigDVGetter(v) /* DataView[MethodName] values for GETTERS */;
              f._.setters[v] =
                sigDVSetter(v) /* DataView[MethodName] values for SETTERS */;
              f._.sw[v] =
                sigDVSetWrapper(
                  v
                ) /* BigInt or Number ctor to wrap around values
                                           for conversion */;
            });
...
*/
  ...
  */
     ...
     need... */
      ...
      'string:flexible'-type arguments */ const xString =
            wasm.xWrap.argAdapter("string");
          wasm.xWrap.argAdapter("string:flexible", (v) =>
            xString(util.flexibleString(v))
          );
    ...
    */
          ...
          wasm.xWrap.argAdapter("sqlite3_filename", aPtr)(
            "sqlite3_context*",
            aPtr
          )("sqlite3_value*", aPtr)("void*", aPtr)("sqlite3_stmt*", (v) =>
            aPtr(v instanceof (sqlite3?.oo1?.Stmt || nilType) ? v.pointer : v)
          )("sqlite3*", (v) =>
            aPtr(v instanceof (sqlite3?.oo1?.DB || nilType) ? v.pointer : v)
          )("sqlite3_index_info*", (v) =>
            aPtr(
              v instanceof (capi.sqlite3_index_info || nilType) ? v.pointer : v
            )
          )("sqlite3_module*", (v) =>
            aPtr(v instanceof (capi.sqlite3_module || nilType) ? v.pointer : v)
          )(
            /**
       `sqlite3_vfs*`:
    ...
    */
          ...
          wasm.xWrap.resultAdapter("sqlite3*", rPtr)("sqlite3_context*", rPtr)(
            "sqlite3_stmt*",
            rPtr
          )("sqlite3_value*", rPtr)("sqlite3_vfs*", rPtr)("void*", rPtr);
  ...
  */
        ...
        if (1) {
          /* Bindings for sqlite3_create_collation() */
    ...
    */
        ...
        if (1) {
          ...
          capi.sqlite3_create_function_v2 = function f(
            ...
            const uninstall = [
              /*funcs to uninstall on error*/
            ];
            let rc;
            try {
              const funcArgs = __xWrapFuncs(
                { xFunc, xStep, xFinal, xDestroy },
                uninstall
              );
              rc = sqlite3CreateFunction(
                pDb,
                funcName,
                nArg,
                eTextRep,
          ...
          capi.sqlite3_create_window_function = function f(
            ...
            try {
              ...
              rc = sqlite3CreateWindowFunction(
                pDb,
                funcName,
                nArg,
                eTextRep,
    ...
    */
       ...
       below) must be used.
    */
          __prepare.basic = wasm.xWrap("sqlite3_prepare_v3", "int", [
            "sqlite3*",
            "string",
    ...
    */
          __prepare.full = wasm.xWrap("sqlite3_prepare_v3", "int", [
            "sqlite3*",
            "*",
            "int",
            "int",
        ...
        {
          /* sqlite3_set_authorizer() */ const __ssa = wasm.xWrap(
          ...
          capi.sqlite3_set_authorizer = function (pDb, xAuth, pUserData) {
            if (3 !== arguments.length)
              return __dbArgcMismatch(pDb, "sqlite3_set_authorizer", 3);
    ...
    */ capi.sqlite3_config = function (op, ...args) {
        ...
        {
          /* Import C-level constants and structs... */ const cJson =
            wasm.xCall("sqlite3_wasm_enum_json");
          if (!cJson) {
            toss(
    ...
    */
      ...
      */
            const kvvfsImpls = {
              xRead: (zClass, zKey, zBuf, nBuf) => {
                ...
                try {
                  ...
                  if (!jV) return -1;
                  const nV =
                    jV.length; /* Note that we are relying 100% on v being
      ...
      self.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
        sqlite3.version = {
          libVersion: "3.41.0",
          libVersionNumber: 3041000,
          sourceId:
            "2022-12-16 13:04:21 62e0c931ac952219f68e22d64e20836781bf330b4581e4662266172a97c9289b",
          downloadVersion: 3410000,
        };
      });
...
*/
        ...
        const __dbTraceToConsole = wasm.installFunction(
          ...
          function (t, c, p, x) {
            if (capi.SQLITE_TRACE_STMT === t) {
              ...
              console.log("SQL TRACE #" + ++this.counter, wasm.cstrToJs(x));
            }
          }.bind({ counter: 0 })
        );
  ...
  */
      ...
      */
            ...
            const isWorkerThread =
              "function" ===
              typeof importScripts /*===running in worker thread*/
                ? (n) =>
                    toss3(
                      "The VFS for",
                      n,
  ...
  */
    ...
    */
          exec: function (/*(sql [,obj]) || (obj)*/) {
            ...
            let bind = opt.bind;
            let evalFirstResult = !!(
              arg.cbArg || opt.columnNames
            ); /* true to evaluate the first result-returning query */
           ...
           conversion costs. */ /* Allocate the two output pointers (ppStmt, pzTail) and heap
           ...
           will point to somewhere in pSql. */
              ...
              const pzTail =
                ppStmt + wasm.ptrSizeof; /* final arg to sqlite3_prepare_v2() */
  ...
  */
          ...
          bind: function (/*[ndx,] arg*/) {
           ...
           functions. */
            ...
            if (null === arg) {
              ...
              "object" === typeof arg /*null was checked above*/ &&
    ...
    */
        ...
        {
          /* Add the `pointer` property to DB and Stmt. */ const prop = {
            enumerable: true,
            get: function () {
  ...
  */
          const wMsgHandler = {
           ...
           browser dev console. */
              ...
              rc.persistent =
                (!!pDir && db.filename.startsWith(pDir + "/")) ||
           ...
           row as a message of that type. */
            ...
            "config-get": function () {
              const rc = Object.create(null),
                src = sqlite3.config;
              ["wasmfsOpfsDir", "bigIntEnabled"].forEach(function (k) {
    ...
    */
          ...
          self.onmessage = async function (ev) {
            ...
            if (!dbId) {
              dbId = result.dbId /*from 'open' cmd*/ || getDefaultDbId();
            }
...
*/
      ("use strict");
      self.sqlite3ApiBootstrap.initializers.push(
        function (sqlite3) {
            ...
            try {
              ...
              if (opt.catchExceptions) {
                ...
                installMethods(
                  mod,
                  methods,
                  !!opt.applyArgcCheck /*undocumented option*/
                );
              }
              if (0 === mod.$iVersion) {
                let v;
...
*/
    ...
    */
              ...
              const pDVfs =
                capi.sqlite3_vfs_find(null); /*pointer to default VFS*/
              const dVfs = pDVfs
    ...
    */
         ...
         for that, doing so might lead to undesired side effects. */
                ...
                state.sabOP = new SharedArrayBuffer(
                  i *
                    4 /* ==sizeof int32, noting that Atomics.wait() and friends
           ...
           to encode them... TextEncoder can do that for us. */
                ...
                xOpen: function f(pVfs, zName, pFile, flags, pOutFlags) {
                  ...
                  if (0 === zName) {
                    ...
                    if (
                      capi.sqlite3_uri_boolean(zName, "opfs-unlock-asap", 0)
                    ) {
...
*/
  ...
  */
        const SABC = Object.assign(
          Object.create(null),
          {
            exports: Module["asm"],
            memory:
              Module.wasmMemory /* gets set if built with -sIMPORT_MEMORY */,
          },
  ...
  */
        ...
        Module.sqlite3 =
          sqlite3 /* Needed for customized sqlite3InitModule() to be able to
...
(function () {
  ...
  */
  ...
  initModuleState.debugModule = new URL(self.location.href).searchParams.has(
    "sqlite3.debugModule"
  )
